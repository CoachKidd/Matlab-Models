function createfigure1(ThroughputTotals)
%CREATEFIGURE1(THROUGHPUTTOTALS1)
%  THROUGHPUTTOTALS1:  vector of y data

%  Auto-generated by MATLAB on 08-Jan-2018 11:44:58
...
% Create axes
axes1 = axes('Position',[0.13 0.11 0.775 0.78624060150376]);
hold(axes1,'on');

% Create plot
plot1 = plot(ThroughputTotals,'ZDataSource','',...
    'DisplayName','MTC Throughput',...
...
% Create title
title('Throughput History trend (completed items per week)');
...
set(legend1,...
    'Position',[0.76394370211446 0.818583805162726 0.14594038775744 0.0626385793453309]);
...
% Create textbox
annotation(figure1,'textbox',...
    [0.132287297527707 0.915746364224221 0.771378516624041 0.0315789473684216],...
