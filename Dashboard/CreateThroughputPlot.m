function CreateThroughputPlot(ThroughputTotals)
%CreateThroughputPlot(Y1)
%  Y1:  vector of y data

%  Auto-generated by MATLAB on 05-Jan-2018 13:55:11

% Create figure
figure1 = figure;

% Create axes
axes1 = axes('Parent',figure1,'Position',[0.13 0.11 0.775 0.78624060150376]);
hold(axes1,'on');

% Create plot
plot1 = plot(ThroughputTotals,'ZDataSource','','DisplayName','data1','MarkerEdgeColor',[0 0 0],'Marker','diamond');
...
% Create ylabel
ylabel('Count of closed items during week','HorizontalAlignment','center',...
    'FontWeight','bold',...
    'FontAngle','italic');

% Create xlabel
xlabel('Year-Week Number','HorizontalAlignment','center',...
    'FontWeight','bold',...
    'FontAngle','italic');
...
set(axes1,'XGrid','on','XTickLabel',...
    {'2017-45','2017-46','2017-47','2017-48','2017-49','2017-50','2017-51','NaN-NaN'},...
...
annotation(figure1,'textbox',...
    [0.130204770308573 0.941353383458647 0.773936061381074 0.0536590853692827],...
    'String','Productivity - How Much',...
    'HorizontalAlignment','center',...
    'FontSize',20,...
    'FitBoxToText','off',...
    'BackgroundColor',[0.886274516582489 0.937254905700684 0.854901969432831]);

% Create textbox
annotation(figure1,'textbox',...
    [0.131434782608696 0.843609022556394 0.771378516624041 0.0315789473684217],...
    'String','Throughput History trend (completed items per week)',...
    'LineStyle','none',...
    'HorizontalAlignment','center',...
    'FontWeight','bold',...
    'FontSize',12,...
...
% Create textbox
annotation(figure1,'textbox',...
    [0.132287297527707 0.902255639097745 0.771378516624041 0.0315789473684217],...
    'String','What pace do we deliver work? Goal: Look for ways to increase. Watch quality if you overdrive.',...
    'LineStyle','none',...
    'HorizontalAlignment','center',...
    'FontSize',12,...
    'FitBoxToText','off');
