%% Import data from text file - as Table.
...
%% Import data from text file - as Column Vectors.
% Script for importing data from the following text file:
%
%    /Users/andrewkidd/Documents/GitHub/Resources/Bingo Ball Machine/Data.csv
%
...
% Auto-generated by MATLAB on 2018/02/08 20:20:13
...
Girls_max = cell2mat(raw(:, 1));
Boys_max = cell2mat(raw(:, 2));
Total = cell2mat(raw(:, 3));
